...
import { Loader2, Plane, Mail, Lock, User } from 'lucide-react';
import { z } from 'zod';
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: 'Welcome to Smart Travel Planner.',
      });
      navigate('/dashboard');
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted to-background flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md relative z-10 shadow-xl border-border/50 backdrop-blur-sm">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            <CardTitle className="text-2xl font-bold">Smart Travel Planner</CardTitle>
